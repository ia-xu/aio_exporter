...
def download():
    # cache_dir = get_work_dir() / 'cache_st_dir'
    # if cache_dir.exists():
    ...
    # 简单展示
    show_im = st.checkbox('展示图片/展示转换后的 md 文件', True)

    select_article = st.selectbox('挑选文章', filter_df.title.to_list())
